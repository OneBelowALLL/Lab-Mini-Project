...
searcing_call_again:
        ...
        {
            if(destination==13) printing_path_4("FRESH ROOM");
...
void creating_the_map()
{
    ...
    path_4("FRESH ROOM","aqua_atmosphere","take left turn then straight 15m then turn right-> take left turn then straight 15m location is in your right side");
...
//eta korte sob theke besi somoi lagse huuuuuuuuuur
    ...
    printf("\t\t\t\t4. ACADEMIC BUILDING - 3\t\t\t13. FRESH ROOM\n");
    printf("\t\t\t\t   tower_of_thought\t\t\t\t    aqua_atmosphere\n\n");
